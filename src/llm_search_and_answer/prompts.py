...
- В тексте вопроса (user_question) вы получите задание и ответ руководителя
- В контексте (combined_final_content) предоставлен учебный материал, содержащий:
  * Номера подглав в тегах <content_subchapter id='X.X.X'>
  * Заголовки в тегах <title>
  * Номера страниц в тегах <number_pages>
  * Краткое содержание страниц в тегах <summary>
...
2. ОБРАТНАЯ СВЯЗЬ
   ...
   - Укажите конкретную подглаву и страницу для изучения
...
{
  "analysis_text": "Поздравляю, вы успешны! Ваш ответ принесет вам дополнительные баллы. В подглаве 3.11.2 автор действительно указывает на важность отслеживания как ключевого элемента развития лидерских навыков. Ваше понимание четырех уроков полностью соответствует материалу книги. Рекомендую применить эти знания в ежедневной практике управления командой.",
  "evaluation": "ВЕРНО"
}

Пример 2 (неправильный ответ):
{
  "analysis_text": "Ваш ответ требует доработки. В подглаве 3.12.1 автор объясняет совершенно другие принципы. Изучите страницы 45-47, где подробно описаны корректные подходы к решению данной проблемы. Рекомендую пересмотреть свой подход и обратить внимание на практические примеры, приведенные автором.",
  "evaluation": "НЕВЕРНО"
}
