...
def test_pipeline_execution(result: SubchaptersTestResult):
    ...
    Урок второй: между пониманием и действием большая дистанция. 
    Урок третий: люди не становятся лучше без отслеживания.
    Урок четвертый: отслеживание помогает видеть прогресс.
    """
    ...
    try:
        ...
        print(f"  📝 Начало ответа LLM: {final_answer[:100]}...")
